...
.DESCRIPTION
    ...
    - Region (Region used by accunt.  If more than one Region is in use, run this cmdlet multiple times, once for each account/region pair )
...
.NOTES
    ...
    https://github.com/RobBiddle/Get-AwsTemporaryCredential
    Get-AwsTemporaryCredential  Copyright (C) 2017  Robert D. Biddle
    This program comes with ABSOLUTELY NO WARRANTY; for details type `"help New-Get-AwsTemporaryCredential -full`".
    This is free software, and you are welcome to redistribute it
    under certain conditions; for details type `"help New-Get-AwsTemporaryCredential -full`".
...
function Get-AwsTemporaryCredential {
    ...
    $AwsTemporaryCredentials | Add-Member -MemberType NoteProperty -Name "Alias" -Value $Alias
...
Export-ModuleMember -Cmdlet Get-AwsTemporaryCredential -Function Get-AwsTemporaryCredential
